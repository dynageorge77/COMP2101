...
#   - use the same kind of testing that is already in the script to only download the tarfile if
#you don't already have it and  to make sure the download and extraction commands work, then delete
#the local copy of the tarfile if the extraction was successful
